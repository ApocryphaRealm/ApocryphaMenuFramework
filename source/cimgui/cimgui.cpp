...
{
    if (!str_id) { str_id = ""; }   // AMF null guard
...
{
    if (!str_id_begin) { str_id_begin = ""; }   // AMF null guard
...
{
    if (!label) { label = ""; }   // AMF null guard
    if (!current_item) { return false; }   // AMF null guard
...
{
    if (!label) { label = ""; }   // AMF null guard
    if (!v_current_min) { return false; }   // AMF null guard
    if (!v_current_max) { return false; }   // AMF null guard
...
{
    if (!label) { label = ""; }   // AMF null guard
    if (!v_rad) { return false; }   // AMF null guard
...
{
    if (!desc_id) { desc_id = ""; }   // AMF null guard
...
{
    if (!prefix) { prefix = ""; }   // AMF null guard
...
{
    if (!tab_or_docked_window_label) { tab_or_docked_window_label = ""; }   // AMF null guard
...
{
    if (!out_h) { return; }   // AMF null guard
    if (!out_s) { return; }   // AMF null guard
    if (!out_v) { return; }   // AMF null guard
    return ImGui::ColorConvertRGBtoHSV(r,g,b,*out_h,*out_s,*out_v);
}
CIMGUI_API void igColorConvertHSVtoRGB(float h,float s,float v,float* out_r,float* out_g,float* out_b)
{
    if (!out_r) { return; }   // AMF null guard
    if (!out_g) { return; }   // AMF null guard
    if (!out_b) { return; }   // AMF null guard
...
{
    if (!ini_filename) { ini_filename = ""; }   // AMF null guard
...
{
    if (!ini_data) { ini_data = ""; }   // AMF null guard
...
{
    if (!out_ini_size) { return nullptr; }   // AMF null guard
...
{
    if (!version_str) { version_str = ""; }   // AMF null guard
...
{
    if (!self) { return false; }   // AMF null guard
...
{
    if (!default_filter) { default_filter = ""; }   // AMF null guard
...
{
    if (!self) { return nullptr; }   // AMF null guard
    return self->begin();
}
...
{
    if (!self) { return 0; }   // AMF null guard
    return self->size();
}
...
{
    if (!self) { return 0.0f; }   // AMF null guard
...
{
    if (!self) { return; }   // AMF null guard
    if (!out_width) { return; }   // AMF null guard
    if (!out_height) { return; }   // AMF null guard
    if (!out_bytes_per_pixel) { return; }   // AMF null guard
...
{
    if (!str_begin) { str_begin = ""; }   // AMF null guard
...
{
    if (!haystack) { haystack = ""; }   // AMF null guard
...
{
    if (!format) { format = ""; }   // AMF null guard
...
{
    if (!fmt_in) { fmt_in = ""; }   // AMF null guard
...
{
    if (!out_char) { return 0; }   // AMF null guard
...
{
    if (!out_buf) { return 0; }   // AMF null guard
...
{
    if (!in_text) { in_text = ""; }   // AMF null guard
...
{
    if (!in_text_start) { in_text_start = ""; }   // AMF null guard
...
{
    if (!filename) { filename = ""; }   // AMF null guard
...
{
    if (!filename) { filename = ""; }   // AMF null guard
    if (!out_file_size) { return nullptr; }   // AMF null guard
...
{
    if (!out_u) { return; }   // AMF null guard
    if (!out_v) { return; }   // AMF null guard
    if (!out_w) { return; }   // AMF null guard
...
{
    if (!type_name) { type_name = ""; }   // AMF null guard
...
{
    if (!repeat_delay) { return; }   // AMF null guard
    if (!repeat_rate) { return; }   // AMF null guard
...
{
    if (!window_name) { window_name = ""; }   // AMF null guard
...
{
    if (!out_id_at_dir) { return 0; }   // AMF null guard
    if (!out_id_at_opposite_dir) { return 0; }   // AMF null guard
...
{
    if (!src_name) { src_name = ""; }   // AMF null guard
...
{
    if (!out_just_closed) { return; }   // AMF null guard
    if (!out_text_clipped) { return; }   // AMF null guard
...
{
    if (!out_hovered) { return false; }   // AMF null guard
    if (!out_held) { return false; }   // AMF null guard
...
{
    if (!size1) { return false; }   // AMF null guard
    if (!size2) { return false; }   // AMF null guard
...
{
    if (!line_begin) { line_begin = ""; }   // AMF null guard
